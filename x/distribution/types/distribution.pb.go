...
//
type YieldTokenization struct {
	Id           uint64                                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" yaml:"id"`
	Shares       github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=shares,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"shares"`
...
func (m *YieldTokenization) Reset()         { *m = YieldTokenization{} }
func (m *YieldTokenization) String() string { return proto.CompactTextString(m) }
func (*YieldTokenization) ProtoMessage()    {}
func (*YieldTokenization) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3e6168184371676, []int{12}
}
func (m *YieldTokenization) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *YieldTokenization) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_YieldTokenization.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *YieldTokenization) XXX_Merge(src proto.Message) {
	xxx_messageInfo_YieldTokenization.Merge(m, src)
}
func (m *YieldTokenization) XXX_Size() int {
	return m.Size()
}
func (m *YieldTokenization) XXX_DiscardUnknown() {
	xxx_messageInfo_YieldTokenization.DiscardUnknown(m)
}

var xxx_messageInfo_YieldTokenization proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*YieldTokenization)(nil), "liquidstaking.distribution.v1beta1.YieldTokenization")
}
...
var fileDescriptor_c3e6168184371676 = []byte{
	...
	,
}
...
func (this *YieldTokenization) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*YieldTokenization)
	if !ok {
		that2, ok := that.(YieldTokenization)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *YieldTokenization) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *YieldTokenization) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *YieldTokenization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TokenAddress) > 0 {
		...
		i = encodeVarintDistribution(dAtA, i, uint64(len(m.TokenAddress)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *YieldTokenization) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *YieldTokenization) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: YieldTokenization: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: YieldTokenization: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
