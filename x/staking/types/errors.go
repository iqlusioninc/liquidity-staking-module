...
var (
	...
	ErrValidatorBondNotAllowedFromModuleAccount = sdkerrors.Register(ModuleName, 52, "validator bond is not allowed from a module account")
	ErrGlobalLiquidStakingCapExceeded           = sdkerrors.Register(ModuleName, 53, "delegation from liquid staking provider exceeds the global cap")
)
