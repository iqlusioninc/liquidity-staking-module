...
var (
	...
	ErrNotEnoughBalance                           = errorsmod.Register(ModuleName, 51, "not enough balance")
	ErrTokenizeShareRecordNotExists               = errorsmod.Register(ModuleName, 52, "tokenize share record not exists")
	ErrTokenizeShareRecordAlreadyExists           = errorsmod.Register(ModuleName, 53, "tokenize share record already exists")
	ErrNotTokenizeShareRecordOwner                = errorsmod.Register(ModuleName, 54, "not tokenize share record owner")
	ErrExceedingFreeVestingDelegations            = errorsmod.Register(ModuleName, 55, "trying to exceed vested free delegation for vesting account")
	ErrOnlyBondDenomAllowdForTokenize             = errorsmod.Register(ModuleName, 56, "only bond denom is allowed for tokenize")
	ErrInsufficientExemptShares                   = errorsmod.Register(ModuleName, 57, "insufficient exempt shares")
	ErrRedelegationNotAllowedForExemptDelegation  = errorsmod.Register(ModuleName, 58, "redelegation is not allowed for exempt delegation")
	ErrExemptDelegationNotAllowedForTokenizeShare = errorsmod.Register(ModuleName, 59, "exempt delegation is not allowed for tokenize share")
)
