...
var (
	...
	ErrValidatorLiquidStakingCapExceeded        = errorsmod.Register(ModuleName, 53, "delegation from liquid staking provider exceeds the validator cap")
	ErrTokenizeSharesDisabledForAccount         = errorsmod.Register(ModuleName, 54, "tokenize shares currently disabled for account")
