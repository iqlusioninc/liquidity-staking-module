...
var (
	...
	ErrTokenizeSharesAlreadyEnabledForAccount   = sdkerrors.Register(ModuleName, 56, "tokenize shares is already enabled for this account")
	ErrTokenizeSharesAlreadyDisabledForAccount  = sdkerrors.Register(ModuleName, 57, "tokenize shares is already disabled for this account")
)
